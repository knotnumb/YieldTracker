...
const YS_VAULTS = [
  ...
  { name: 'Steakhouse High Yield USDC v1.1', match: { project: /morpho/i, pool: /bbqusdc/i, chain: /base/i }, morpho: { address: '0xBEEFA7B88064FeEF0cEe02AAeBBd95D30df3878F', chainId: 8453 }, type: 'lending' },
  { name: 'Steakhouse Prime USDC', match: { project: /morpho/i, pool: /^steakusdc$/i, chain: /base/i }, morpho: { address: '0xBEEFE94c8aD530842bfE7d8B397938fFc1cb83b2', chainId: 8453 }, type: 'lending' },
  { name: 'Aave Base USDC', match: { project: /aave v3/i, pool: /usdc/i, chain: /base/i }, morpho: null, type: 'lending' },
  { name: 'Spark USDC Vault', match: { project: /morpho/i, pool: /sparkusdc/i, chain: /base/i }, morpho: { address: '0x7BfA7C4f149E7415b73bdeDfe609237e29CBF34A', chainId: 8453 }, type: 'lending' },
  { name: 'Gauntlet USDC Frontier', match: { project: /morpho/i, pool: /gtusdcf/i, chain: /base/i }, morpho: { address: '0x236919F11ff9eA9550A4287696C2FC9e18E6e890', chainId: 8453 }, type: 'lending' },
